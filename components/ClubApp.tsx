                ...
                <div className="mt-4 rounded-lg bg-mist p-3 text-left">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="text-xs font-semibold text-ink/55">Current progress: {resolvedRounds} of {totalRounds} rounds resolved</p>
                    </div>
                    <button
...
function PlayerAvailabilitySection({
  players,
  sessionPlayerStatuses,
  onStatusChange
}: {
...
function CourtCard({
  ...
  const canSave = teamAScore !== teamBScore && teamAScore <= 21 && teamBScore <= 21;
      ...
      <div className="max-h-[82vh] w-full max-w-md overflow-hidden rounded-lg bg-white shadow-soft md:max-w-xl">
        <div className="flex items-start justify-between gap-3 border-b border-ink/10 p-4">
          <div>
            ...
            <p className="mt-1 text-xs font-bold text-ink/50">Choose 0-21</p>
          </div>
          <button
            onClick={onClose}
